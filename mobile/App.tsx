...
const styles = StyleSheet.create({
  ...
  accountScroll:{padding:16,paddingBottom:40},accountHero:{padding:26,alignItems:'center',borderRadius:22,backgroundColor:'#173f31'},accountAvatar:{width:72,height:72,alignItems:'center',justifyContent:'center',borderRadius:24,backgroundColor:'#c9f47b'},accountInitials:{color:'#234332',fontSize:22,fontWeight:'900'},accountName:{marginTop:15,color:'#fff',fontSize:23,fontWeight:'900'},accountRole:{marginTop:6,color:'#a9c3b7',fontSize:9,fontWeight:'800',letterSpacing:1.3},accountGymCard:{marginTop:12,padding:20,borderWidth:1,borderColor:'#e2e7e3',borderRadius:17,backgroundColor:'#fff'},accountGymLabel:{color:'#7a857f',fontSize:9,fontWeight:'800',letterSpacing:1.2},accountGymName:{marginTop:8,color:'#24342c',fontSize:18,fontWeight:'900'},logoutButton:{minHeight:69,marginTop:18,padding:13,flexDirection:'row',alignItems:'center',borderWidth:1,borderColor:'#efcec9',borderRadius:15,backgroundColor:'#fff9f8'},logoutButtonPressed:{opacity:.7},logoutIcon:{width:42,height:42,marginRight:12,alignItems:'center',justifyContent:'center',borderRadius:13,backgroundColor:'#fee5e1'},logoutIconText:{color:'#a8453c',fontSize:20,fontWeight:'900'},logoutTitle:{color:'#a8453c',fontSize:13,fontWeight:'900'},logoutCopy:{marginTop:4,color:'#8b7774',fontSize:9},accountVersion:{marginTop:28,color:'#929b96',fontSize:9,letterSpacing:1.2,textAlign:'center'},
