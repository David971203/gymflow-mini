...
function AdminApp({ user, onLogout }: { user: User; onLogout: () => void }) {
  ...
  return <SafeAreaView style={styles.app}><StatusBar barStyle="dark-content" />
    <View style={styles.topbar}>
      ...
      <Pressable accessibilityRole="button" accessibilityLabel="Abrir mi cuenta" onPress={() => setTab('CUENTA')} style={styles.avatar}><Text>{user.name.slice(0, 2).toUpperCase()}</Text></Pressable>
    </View>
