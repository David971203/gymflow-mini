...
function MembersScreen({ scope, revision }: ScreenProps) {
  ...
  return <>
    ...
    <MemberActions member={selected} onClose={() => setSelected(null)} onEdit={() => { if (selected) setEditing(selected); setSelected(null); }} onPlan={() => { if (selected) setAssigning(selected); setSelected(null); }} />
