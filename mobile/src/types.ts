...
export type SyncOperationType = 'MEMBER_CREATE' | 'MEMBER_UPDATE' | 'MEMBER_DELETE' | 'PLAN_CREATE' | 'PLAN_UPDATE' | 'PLAN_DELETE' | 'MEMBERSHIP_ASSIGN' | 'MEMBERSHIP_UPDATE' | 'MEMBERSHIP_RENEW' | 'MEMBERSHIP_DELETE' | 'PAYMENT_APPLY' | 'ATTENDANCE_CHECK_IN' | 'ATTENDANCE_CHECK_OUT';
