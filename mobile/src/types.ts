...
export type Payment = { id: string; amount: string; paidAmount: string; status: string; member: Member; membership: { plan: Plan }; movements: Movement[] };
...
export type SyncOperationType = 'MEMBER_CREATE' | 'MEMBER_UPDATE' | 'PLAN_CREATE' | 'PLAN_UPDATE' | 'MEMBERSHIP_ASSIGN' | 'MEMBERSHIP_RENEW' | 'PAYMENT_APPLY';
